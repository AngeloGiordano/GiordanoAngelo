...
/**
 * This is the extension manager of the Projectcycle extension.
 */
public class ProjectcycleManager extends GeneratedProjectcycleManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ProjectcycleManager.class);
	 ...
	 */
	public static ProjectcycleManager getInstance()
	{
		return (ProjectcycleManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ProjectcycleConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProjectcycleManager() // NOPMD 
	{
		LOG.debug("constructor of ProjectcycleManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ProjectcycleManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ProjectcycleManager called, current tenant: {}", getTenant().getTenantID());
	}
