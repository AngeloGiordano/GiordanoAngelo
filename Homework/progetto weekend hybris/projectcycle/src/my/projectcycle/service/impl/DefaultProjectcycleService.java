...
public class DefaultProjectcycleService implements ProjectcycleService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultProjectcycleService.class);
	...
	{
		return DefaultProjectcycleService.class.getResourceAsStream("/projectcycle/sap-hybris-platform.png");
	}
