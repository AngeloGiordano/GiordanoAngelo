...
public class DefaultProjectHospitalService implements ProjectHospitalService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultProjectHospitalService.class);
	...
	{
		return DefaultProjectHospitalService.class.getResourceAsStream("/projectHospital/sap-hybris-platform.png");
	}
