...
/**
 * This is the extension manager of the ProjectHospital extension.
 */
public class ProjectHospitalManager extends GeneratedProjectHospitalManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ProjectHospitalManager.class);
	 ...
	 */
	public static ProjectHospitalManager getInstance()
	{
		return (ProjectHospitalManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ProjectHospitalConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProjectHospitalManager() // NOPMD 
	{
		LOG.debug("constructor of ProjectHospitalManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ProjectHospitalManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ProjectHospitalManager called, current tenant: {}", getTenant().getTenantID());
	}
